    ...
    public class MockDictionary<TKey, TValue> : ICollection<KeyValuePair<TKey, TValue>>, IEnumerable<KeyValuePair<TKey, TValue>>, IEnumerable, IReadOnlyCollection<KeyValuePair<TKey, TValue>>
    {
        ...
        public TValue this[TKey key]
        {
            get
            {
                ...
                {
                    throw new Exception("Race in get Value");
                }
            ...
            set
            {
                ...
                {
                    throw new Exception("Race in set Value");
                }
        ...
        public bool ContainsKey(TKey key)
        {
            ...
            if (this.sharedEntry != TaskId && this.IsWrite)
            {
                throw new Exception("Race in ContainsKey()");
            }
        ...
        public bool Remove(TKey key)
        {
            ...
            if (this.sharedEntry != TaskId)
            {
                throw new Exception("Race in Remove()");
            }
        ...
        public void Add(KeyValuePair<TKey, TValue> item)
        {
            ...
            if (this.sharedEntry != TaskId)
            {
                throw new Exception("Race in Add(KeyValuePair)");
            }
        ...
        public void Clear()
        {
            ...
            if (this.sharedEntry != TaskId)
            {
                throw new Exception("Race in Clear");
            }
        ...
        public bool Contains(KeyValuePair<TKey, TValue> item)
        {
            ...
            if (this.sharedEntry != TaskId && this.IsWrite)
            {
                throw new Exception("Race in Contains(KeyValuePair)");
            }
        ...
        public void CopyTo(KeyValuePair<TKey, TValue>[] array, int arrayIndex)
        {
            ...
            if (this.sharedEntry != TaskId && this.IsWrite)
            {
                throw new Exception("Race in CopyTo()");
            }
        ...
        public IEnumerator<KeyValuePair<TKey, TValue>> GetEnumerator()
        {
            ...
            if (this.sharedEntry != TaskId && this.IsWrite)
            {
                throw new Exception("Race in GetEnumerator()");
            }
        ...
        public bool TryGetValue(TKey key, out TValue value)
        {
            ...
            if (this.sharedEntry != TaskId && this.IsWrite)
            {
                throw new Exception("Race in TryGetValue()");
            }
