...
namespace k8s
{
    ...
    public class StreamDemuxer : IStreamDemuxer
    {
        ...
        private readonly Nekara.MockDictionary<byte, ByteBuffer> buffers = new Nekara.MockDictionary<byte, ByteBuffer>();
        private readonly CancellationTokenSource cts = new CancellationTokenSource();
        private readonly StreamType streamType;
        private readonly bool ownsSocket;
        private Task runLoop;
        private bool disposedValue;
        // Replace default locks with Coyote's Semaphore.
        private Microsoft.Coyote.Tasks.Semaphore sem = Microsoft.Coyote.Tasks.Semaphore.Create(0, 2);
