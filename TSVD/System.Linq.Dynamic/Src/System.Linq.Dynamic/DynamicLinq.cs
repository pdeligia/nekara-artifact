...
namespace Linq.Dynamic
{
    ...
    public static class DynamicExpression
    {
        ...
        public static Type CreateClass(params DynamicProperty[] properties)
        {
            ...
            var x = ClassFactory.Instance.GetDynamicClass(properties);
    ...
    internal class ClassFactory
    {
        ...
        Nekara.MockDictionary<Signature, Type> classes;
        int classCount;
        ReaderWriterLock rwLock;
        Microsoft.Coyote.Tasks.Semaphore sem;
        ...
        private ClassFactory()
        {
            ...
            classes = new Nekara.MockDictionary<Signature, Type>();
            rwLock = new ReaderWriterLock();
            sem = Microsoft.Coyote.Tasks.Semaphore.Create(0,1);
        }
