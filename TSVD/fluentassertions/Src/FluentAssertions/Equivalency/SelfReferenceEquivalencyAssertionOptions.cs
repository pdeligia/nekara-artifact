...
namespace FluentAssertions.Equivalency
{
        ...
        where TSelf : SelfReferenceEquivalencyAssertionOptions<TSelf>
    {
        ...
        private readonly Nekara.MockDictionary<Type, bool> hasValueSemanticsMap = new Nekara.MockDictionary<Type, bool>();
        ...
        EqualityStrategy IEquivalencyAssertionOptions.GetEqualityStrategy(Type type)
        {
            ...
            else
            {
                ...
                {
                    // Udit: TryGetValue and indexer, if run concurrently, can produce an error
                    if (!hasValueSemanticsMap.TryGetValue(type, out bool hasValueSemantics))
                    {
                        ...
                        Debug.Assert(hasValueSemanticsMap[type] == hasValueSemantics);
                        Debug.Assert(false);
                    }
