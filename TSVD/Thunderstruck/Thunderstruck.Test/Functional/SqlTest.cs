...
namespace Thunderstruck.Test.Functional
{
    ...
    public class SqlTest
    {
        ...
        public static void G_DataContext_Should_Execute_A_Procedure()
        {
            var tasks = new List<Task>() {

                Task.Run(() =>
                { _ = new DataContext("Default1", Transaction.Begin); }),
                Task.Run(() =>
                { _ = new DataContext("Default1", Transaction.Begin); })
            };
        ...
        [TestMethod]
        public static void CoyoteTestRace()
        {
            ...
            for(int j =0; j < 4; j++)
            {
                Tasks.Add(Task.Run(() =>
                {
                    ...
                    var context = new DataContext("Default1", Transaction.Begin);
